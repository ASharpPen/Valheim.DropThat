...
internal class ConditionInfusion : ICondition
{
    ...
    {
        if (config.ConditionInfusion.Value.Count > 0)
        {
            var states = config.ConditionInfusion.Value;
    ...
    {
        if (config.ConditionNotInfusion.Value.Count > 0)
        {
            var states = config.ConditionNotInfusion.Value;
