...
internal class ConditionCreatureExtraEffect : ICondition
{
    ...
    {
        if (config.ConditionExtraEffect.Value.Count > 0)
        {
            var states = config.ConditionExtraEffect.Value;
    ...
    {
        if (config.ConditionNotExtraEffect.Value.Count > 0)
        {
            var states = config.ConditionNotExtraEffect.Value;
