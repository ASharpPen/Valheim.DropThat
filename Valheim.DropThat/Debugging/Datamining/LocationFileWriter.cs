...
internal static class LocationFileWriter
{
    ...
    public static void WriteToFile(List<ZoneSystem.ZoneLocation> zoneLocations)
    {
        try
        {
            ...
            // Add header
            stringBuilder.AppendLine($"# This file was auto-generated by Drop That {DropThatPlugin.Version} at {DateTimeOffset.UtcNow.ToString("u")}, with Valheim '{Version.m_major}.{Version.m_minor}.{Version.m_patch}'.");
