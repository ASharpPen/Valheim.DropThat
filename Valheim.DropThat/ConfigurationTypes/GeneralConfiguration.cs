...
namespace Valheim.DropThat.ConfigurationTypes
{
    public class GeneralConfiguration
    {
        ...
        public ConfigEntry<bool> ApplyConditionsOnDeath { get; set; }
        ...
        public void Load(ConfigFile configFile)
        {
            ...
            ApplyConditionsOnDeath = configFile.Bind<bool>("DropTables", nameof(ApplyConditionsOnDeath), false, "When enabled, drop conditions are checked at time of death, instead of at time of spawn.");
